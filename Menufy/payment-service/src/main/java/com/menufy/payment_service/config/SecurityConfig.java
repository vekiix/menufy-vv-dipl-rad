...
import com.menufy.payment_service.config.ExceptionHandlingFilter;
    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(request -> { request
                        .requestMatchers(HttpMethod.POST, "/payment/{id}").hasAuthority("GUEST")
                        .requestMatchers(HttpMethod.GET, "/payment/parameters").hasAuthority("USER")
                        .requestMatchers(HttpMethod.POST, "/payment/parameters").hasAuthority("USER")
